...
class SensorService:
    def __init__(self):
        ...
        self._minioClient = minio.Minio(self._minio_endpoint, access_key=self._minio_access_key, secret_key=self._minio_secret_key ,secure=False)
    ...
    async def save_smart_thermo(self, date: str, sample: Dict[str, Measurement]):
        ...
        self._minioClient.put_object(self._smart_thermo_bucket, f"{date}.csv", io.BytesIO(data), len(data))
